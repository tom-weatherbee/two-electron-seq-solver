...
def nevilleAlgo(i, j, z, excitation):
    if i == j:
        return eigensystem_r(9, (i + 4) * 5, z, excitation, True)
    else:
        hi2 = (9 / (i + 4) / 5)**2
        hj2 = (9 / (j + 4) / 5)**2
        return (nevilleAlgo(i, j - 1, z, excitation) * hj2 - hi2 * nevilleAlgo(i + 1, j, z, excitation)) / (hj2 - hi2)
